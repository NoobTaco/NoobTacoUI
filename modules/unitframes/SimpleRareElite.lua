...
local function SetSimpleRareElite(Texture)
    ...
    SimpleRareElite.Texture:SetTexture(
        'Interface\\AddOns\\NoobTacoUI-Media\\Media\\Textures\\' .. Texture)
...
local function CreateSimpleRareElite()
    ...
    SimpleRareElite:SetScript('OnEvent', function(self, event)
        ...
        elseif event == "PLAYER_TARGET_CHANGED" then
            ...
            local TargetClass = UnitIsPlayer('target') and
                                    select(2, UnitClass('target')) or
