...
I use AI as a high-powered assistant, not a replacement for engineering. Its role in this repository is strictly limited to:

- **Documentation**: Enhancing READMEs and clarifying code comments for better user and developer understanding.
- **Boilerplate & Repetitive Tasks**: Automating mundane, low-risk syntax patterns (like localized string tables or simple table structures).
- **Proofreading**: Identifying potential typos or syntax errors before they reach the testing phase.
