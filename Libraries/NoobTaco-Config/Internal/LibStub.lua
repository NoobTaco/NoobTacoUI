-- LibStub is a minimalistic versioning library for World of Warcraft addons.
-- It allows multiple addons to share libraries and ensures the newest version is used.
